...
# Idea
An education helper system to show the student career pathway in a concise and easy graph. the graph below demonstrated a usual used way for the website. User can click the area that they are interested, we will use Electrical Engineering as an example, please click "EE".
...
A basic introduction link ("info") is placed at each page, user can click it to obtain a brief introduction, for example, an introduction to "EE" and "DSP", the example page is
shown below.
